...
/// mastered.
///
/// Declaration order is load-bearing: `VocabDomain`'s interval lookup and
/// its upgrade/downgrade chain both index off this ordering via `.index`,
/// so reordering these values silently changes scheduling.
